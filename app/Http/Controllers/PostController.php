...
class PostController extends Controller
{
    public function getIndex(Store $session) {
      $post = new Post();
      $posts = $post->getPosts($session);// Here we call our Model object method to check if we store data in session and retrive that data and save it in the variable
